...
module.exports = class FavoriteCampground {
  ...
  static async createFavorite({ user_id, facility_id, facility_name, facility_description, facility_directions, facility_phone, facility_email, reservable, images }){
    ...
    const { rows } = await pool.query(`
        ...
        RETURNING *`, [user_id, facility_id, facility_name, facility_description, facility_directions, facility_phone, facility_email, reservable]);
